...
//			rs = stmt.executeQuery("select *from emp");
			int updated = stmt.executeUpdate("delete from emp where salary>=100 and salary<=500");
			
			System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
			
			if(updated!=0) {
				System.out.println("Total records deleted : "+updated);
			}
